...
| 2026-09-15 | indexace | Scholar drží překlady whitepaperu jako samostatné práce | — | 2 | Web nabízí 47 jazykových verzí a Scholar každou indexuje zvlášť, takže se citace budou rozmělňovat. U části jazyků navíc vyrobil falešného spoluautora (P Kudrna, T Praha), protože překlady jsou pořád Draft v1 z března, tedy bez afiliace, a pod jménem autora tak stojí rovnou přeložené město. Vyřešeno týž den metadaty, viz další řádek. |
| 2026-09-15 | indexace | Do 46 přeložených whitepaperů doplněna metadata | `fix(documents)` v repu personix | 2 | Ukázalo se, že zdrojové .tex překladů neexistují, žily ve scratchpadu a v gitu jsou jen hotová PDF, takže rekompilace nepřipadá v úvahu. Překlady ale neměly v PDF žádná metadata, ani autora. Bez nich si Scholar autora dohaduje z textu, odtud falešný spoluautor. Autor, předmět a klíčová slova se slovem Personix zapsány přes pikepdf do hotových PDF, název všem kromě arabštiny a hebrejštiny kvůli obousměrnému textu. Nasazeno na produkci a ověřeno. Rozdrobení na 47 prací tím nemizí, to autor vyvolat nemůže. |
| 2026-09-15 | indexace | Zdroje překladů zachráněny z transkriptů a všech 46 přebuildováno s afiliací | `docs(whitepaper)`, `feat(whitepaper)` v repu personix | 3 | Ukázalo se, že v červenci se commitla jen hotová PDF a zdrojové .tex zmizely se scratchpadem, zatímco u pamfletu se o den později commitly správně. Time Machine by nepomohla, adresář je ze záloh vyloučený. Soubory se ale daly vytáhnout z transkriptů subagentů, protože obsah psaný nástrojem Write je součástí volání. Všech 46 zachráněno kompletních, uloženo do gitu, doplněna afiliace Personix Project do titulek a znovu sestaveno. Build skript je nově taky v gitu. |
