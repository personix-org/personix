---
title: Pitch pro Palladium Magazine — Irresponsibility Is Free
created: 2026-07-24
status: ready-to-send
target: Palladium Magazine
target_email: editors@palladiummag.com
tags: [outreach, publikace, palladium, pitch]
related: [clanek-osnova-palladium, impact-ledger]
---

# Pitch pro Palladium

Hotový text k odeslání na **editors@palladiummag.com**. Délka 370 slov —
pitchuje se nápad, ne hotový článek.

> **Pozn. k výběru příkladů:** ze čtyř navržených dvojic jsem použil tři —
> rodič a škola, pojištěný a pojišťovna, občan a úředník. Čtvrtou, tedy
> daňového poplatníka proti neplatiči, jsem vynechal záměrně. Není nepravdivá,
> ale jako jediná z nich nese politický náboj a anglofonního redaktora zařadí
> na pravici dřív, než dočte odstavec. Ostatní tři fungují napříč spektrem
> a dělají přesně tutéž práci. Pokud ji tam chceš mít, vrátím ji.

> **Neodesílám sám.** Připravím draft ve schránce personix@personix.org, když
> řekneš. Odesíláš ty po kontrole.

## Předmět

```
Pitch: Irresponsibility Is Free — governance, reputation, and why no alternative has emerged
```
...
| Poslední věta o vlastní práci | Přiznaný zájem, ne propagace. Personix nepadne jménem. |
| Bez odkazů a příloh | První kontakt má být krátký. Odkazy až když se ozvou. |

## Po odeslání

1. Zapsat do [[impact-ledger]] jako typ `publikace`, signál 1
2. Čekat zhruba dva až tři týdny
3. Bez odpovědi jeden zdvořilý follow-up, pak jinam
4. Kanonickou verzi na personix.org publikovat **až po vyjasnění** — magazíny
   běžně odmítají už publikované texty

## Rozhodnuto

- **Lex mercatoria** — v článku bude jako jediný jmenovaný precedens
- **Hirschman** — vynechán, argument funguje bez něj a nestojí za obhajobu v diskusi
- **Titul** — *Irresponsibility Is Free. That Is the Whole Problem.*
