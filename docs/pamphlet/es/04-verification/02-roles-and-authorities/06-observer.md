...
Y aquí está la parte más elegante: **no necesitas observadores reales en absoluto.** Puedes generar números aleatorios que se parezcan exactamente a los códigos de desafío. El verificador no puede notar la diferencia: tiene que tirar los dados sobre si arriesgar o no su reputación. Detrás de cada solicitud que recibe podría haber un observador respetado vigilando de incógnito, o podría ser puro ruido. El verificador no lo sabe. Y esa incertidumbre es el mecanismo.

El coste de mantener la presión honesta: casi cero (los números aleatorios son gratis). El coste potencial de la deshonestidad para el verificador: catastrófico. El comportamiento honesto se incentiva incluso cuando nadie está vigilando de verdad.
