...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north, text width=\paperwidth-50mm, align=justify, font=\small]
    ...
    {%
      ...
      qu'elles gouvernent. Ce livre décrit un outil qui, lui, convient :
      un réseau de réputation décentralisé où l'identité vous appartient,
      où la vérité est publiquement vérifiable, et où la corruption est un
      suicide réputationnel.

      \smallskip
      Pas un manifeste. Pas une prévision. Un plan opérationnel de la façon
