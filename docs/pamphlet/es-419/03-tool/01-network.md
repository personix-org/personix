...
> La selección algorítmica de verificadores garantiza que los publicadores de información no radicales mantendrán, con el tiempo, un equilibrio casi neutro entre los costos de la información publicada y las recompensas por verificar.
...
Sea lo que sea que el verificador decida en respuesta a tu solicitud de verificación, la pelota vuelve al lado del publicador: puede aceptar la oferta del verificador por sus servicios de verificación, incorporar la respuesta a la cronología e intentarlo de nuevo (a mayor costo), o retirarse y asumir el costo ya hundido.
