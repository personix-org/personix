...
Cada rechazo de un verificador agranda tu documento y aumenta su costo de procesamiento: es el primer canal de costo (el crecimiento del documento). Cada nuevo verificador cobra una comisión basada en el volumen de datos, tu reputación, y cuánto se desvía el contenido de tu afirmación de su política de verificación declarada: es el segundo canal de costo (la prima de riesgo). Y cada iteración cuesta tiempo y energía: el tercer canal de costo.
...
El resultado: publicar una afirmación creíble y útil no cuesta casi nada. Publicar una afirmación radical cuesta más. Publicar una mentira se vuelve prohibitivamente caro: debes iterar de verificador en verificador, y cada uno que te rechaza añade costos. El mercado pone precio a tu afirmación, y el precio te dice dónde te sitúas respecto a las comunidades en las que te mueves.
