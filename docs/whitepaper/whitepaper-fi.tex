...
% === PDF metadata ===
\hypersetup{
  pdftitle={Hajautettu mainejärjestelmä: Viitekehys yhteiskunnan luonnolliselle järjestäytymiselle},
...
\author{Pavel Kudrna\\Personix Project --- \url{https://personix.org}\\Praha, Tšekki\\Luonnos v1 --- maaliskuu 2026}
\date{}
