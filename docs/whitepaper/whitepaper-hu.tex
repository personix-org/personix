...
% === PDF metadata ===
\hypersetup{
  pdftitle={Decentralizált reputációs hálózat: Keretrendszer a társadalom természetes szerveződéséhez},
...
\author{Pavel Kudrna\\Personix Project --- \url{https://personix.org}\\Prága, Csehország\\Vázlat v1 --- 2026. március}
\date{}
