...
\usepackage{xurl}
\hypersetup{
  pdftitle={Decentralized Reputation Network: A Framework for Natural Societal Organization},
...
\author{Pavel Kudrna\\Personix Project --- \url{https://personix.org}\\Prague, Czechia\\Draft v3 --- September 2026}
\date{}
...
\item Definition of the \textbf{Reputation Social Network (RSN)}, the decentralized protocol specified by the Personix project, extending the DID framework to support bilateral reputation exchange.
